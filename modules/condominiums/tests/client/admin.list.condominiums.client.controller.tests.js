(function () {
  ...
  describe('Admin Condominiums List Controller Tests', function () {
    // Initialize global variables
    var CondominiumsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _CondominiumsService_) {
      ...
      $httpBackend.whenGET('/modules/condominiums/client/views/list-condominiums.client.view.html').respond(200, '');
      ...
      CondominiumsAdminListController = $controller('CondominiumsAdminListController as vm', {
        $scope: $scope
      });
