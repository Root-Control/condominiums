(function () {
  ...
  describe('Admin Clients List Controller Tests', function () {
    // Initialize global variables
    var ClientsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _ClientsService_) {
      ...
      $httpBackend.whenGET('/modules/clients/client/views/list-clients.client.view.html').respond(200, '');
      ...
      ClientsAdminListController = $controller('ClientsAdminListController as vm', {
        $scope: $scope
      });
