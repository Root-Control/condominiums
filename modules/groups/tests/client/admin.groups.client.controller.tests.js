  ...
  describe('Groups Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (GroupsService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Group saved successfully!' });
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Group save error!' });
      });
    });
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the group and redirect to groups', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Group deleted successfully!' });
        expect($state.go).toHaveBeenCalledWith('admin.groups.list');
      });
